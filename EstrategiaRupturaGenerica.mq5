...
input group "--- Configuración de Horario ---"
input ENUM_MODO_HORARIO modo_horario_in = MODO_MERCADO; // Modo: Mercado (Auto DST) o Broker (Estático)
input ENUM_MARKET_ZONE  zona_mercado_in = ZONE_LONDON;  // Zona de referencia si usas MODO_MERCADO
...
int OnInit()
{
   ...
   modo_horario = modo_horario_in;
   zona_mercado = zona_mercado_in;
